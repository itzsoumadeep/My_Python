...
# def test_microphone():
#     with sr.Microphone() as source:
#         print("Testing microphone... Please speak something.")
#         engine.say("Testing microphone... Please speak something.")
#         engine.runAndWait()
...
#             engine.say("Audio recorded successfully.")
#             engine.runAndWait()
#
...
#             engine.say("No speech detected. Please check your microphone.")
#             engine.runAndWait()
